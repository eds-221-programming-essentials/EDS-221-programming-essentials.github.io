...
```{r}
#| include: false
bird_observations <- read_csv(here::here("course-materials", "eod-practice", "data", "knb-lter-cap_256_9", "52_pp52_birds_1.csv"))
sites <- read_csv(here::here("course-materials", "eod-practice", "data", "knb-lter-cap_256_9", "52_pp52_sites_1.csv"))
surveys <- read_csv(here::here("course-materials", "eod-practice", "data", "knb-lter-cap_256_9", "52_pp52_surveys_1.csv"))
taxalist <- read_csv(here::here("course-materials", "eod-practice", "data", "knb-lter-cap_256_9", "52_pp52_taxalist_1.csv"))
```
...
birds_park_month <- birds_df |> 
  ...
  ungroup(park_name, survey_month) |> 
