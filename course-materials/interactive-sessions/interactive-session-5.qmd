...
-   Fork then clone [this repo](https://github.com/eds-221-programming-essentials/eds221-day5-comp) to create a version-controlled R Project for Day 5

## 2. Warm up - For loops revisited (Leslie Matrix)
...
## 3. Testing functions with `{testthat}`
...
## 6. Finding, vetting and using other packages
