...
```{python, echo = FALSE}
# Read in data
wb_indicators = pd.read_csv('course-materials/interactive-sessions/data/wb_indicators.csv', na_values = ["..",""])

# Read in metadata about indicators
wb_metadata = pd.read_csv('course-materials/interactive-sessions/data/wb_indicators_metadata.csv')
```
