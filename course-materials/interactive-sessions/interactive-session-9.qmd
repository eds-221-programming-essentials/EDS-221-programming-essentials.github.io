...
b. Put your cursor anywhere in the function code within your R script. In the top menu of RStudio, select Code > Insert Roxygen skeleton. The information added is important - it specifies the params (arguments of the function). Now, save the `.R` script (with the file name matching the function name). This now contains your function and the Roxygen information. 

c. Source the `.R` script into your `.qmd`
...
d. Then make a `ggplot` graph that uses your ggplot theme. Done!
